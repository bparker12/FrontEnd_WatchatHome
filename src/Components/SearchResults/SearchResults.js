...
export default class SearchResults extends Component {
    ...
    //         return ""
    //     } else {
    //         return this.props.Utelly.results[0].locations[0].url
    //     }
    //  }
                                    ...
                                    <Grid columns={2}>
                                        <Grid.Row>
                                            ...
                                            <Grid.Column verticalAlign="middle">
                                                <Image floated='right' style={{ margin: 0, height: 112}} size='small' src="https://upload.wikimedia.org/wikipedia/commons/6/64/Poster_not_available.jpg" />
                                            </Grid.Column>
                                        </Grid.Row>
                                    </Grid>
                                </Card.Content>
